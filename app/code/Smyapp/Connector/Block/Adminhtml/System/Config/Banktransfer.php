...
class Banktransfer extends Field
{
    ...
    public function render(AbstractElement $element)
    {
        ...
        if(!$scopeConfig->getValue('payment/banktransfer/active')) {
            $html = "<div id='messages'><ul class='messages'><li class='error-msg'>Bank transfer Payment method is Disabled, Kindly Enable method to make it work with mobile app.<span></span></li></ul></div>";
        }
        return $html;
    }
}
