<?php
/*namespace Smyapp\Connector\Controller\Support;
...
class Support extends \Magento\Framework\App\Action\Action
{
	...
	{		
		$this->loadLayout();
		$this->_title($this->__("Smyapp Support"));
		$this->renderLayout();
	}

		public function landingAction() {

		$version = Mage::getConfig()->getModuleConfig('Smyapp_Connector')->version;
		...
		$data = json_encode($push); 
  		...
  		<div class="loading">  <?php
	  		$image = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_SKIN)."/frontend/base/default/images/Smyapp/magento_logo.png";
	    ...
	    100% {
  		...
  		<script type='text/javascript'>
  			jQuery(document).ready(function() {
  				window.location.href = 'https://www.Smyapp.com/user/activating-app?app=".$final_data."' ;
