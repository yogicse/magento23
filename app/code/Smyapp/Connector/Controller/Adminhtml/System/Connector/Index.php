...
namespace Smyapp\Connector\Controller\Adminhtml\System\Connector;
...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    {
        $moduleCode = 'Smyapp_Connector'; #Edit here with your Namespace_Module
        ...
        $imageUrl         = $this->getViewFileUrl('Smyapp_Connector::images/magento_logo.png');
        ?>
        <div class="loading">
...
<?php
/*          $secure_key = Mage::getStoreConfig('Smyapp/secure/key');
