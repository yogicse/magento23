<?php
namespace Smyapp\Connector\Controller\token;
...
class Getconfiguration extends \Magento\Framework\App\Action\Action
{
    ...
    const XML_SETTING_GOOGLE_CLIENT_ID = 'Smyapp_social/Smyapp_google_key/client_id';
    const XML_SETTING_GOOGLE_SECRET_ID = 'Smyapp_social/Smyapp_google_key/client_secret';
    const XML_SETTING_FACEBOOK_ID      = 'Smyapp_social/Smyapp_facebook_key/facebook_id';
    const XML_SETTING_GOOGLE_SENDER_ID = 'Smyapp_pushnotification/setting_and/googlesenderid';
