...
class Products extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function loadProduct($product_id, $currencyCode)
    {
        ...
        if ($product->getId()) {
            ...
            $productdetail = array(
                ...
                'total_rating'                 => isset($ratingCollection['total_rating']) ? $ratingCollection['total_rating'] : '',
                'symbol'                 => $this->currentCurrency->load($currencyCode)->getCurrencySymbol()?$this->currentCurrency->load($currencyCode)->getCurrencySymbol():$currencyCode,
            ...
            if ($product->getTypeId() == 'configurable') {
                ...
                foreach ($product->getTypeInstance()->getConfigurableAttributes($product) as $attribute) {
                    ...
                    $attributeOptionsData = $this->getAttributeOptionsData($attribute, $options, $productAttribute->getId(), $productAttribute->getAttributeCode());
     ...
     * @return array
     */
    protected function getAttributeOptionsData($attribute, $config, $attributeId = null, $attributeCode = null)
    {
    ...
    protected function getProductDetail($product_id)
    {
        ...
        $result = array(
            ...
            'symbol'                 => $this->currentCurrency->load($this->currentCurrencyCode)->getCurrencySymbol()?$this->currentCurrency->load($this->currentCurrencyCode)->getCurrencySymbol():$currencyCode,
            'qty'                    => $this->stockStateInterface->getStockQty($product_id, $product->getStore()->getWebsiteId()),
            'product_type'           => $product->getTypeId(),
